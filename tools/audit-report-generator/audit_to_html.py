...
@media print{{
  ...
  *{{ -webkit-print-color-adjust:exact !important; print-color-adjust:exact !important; }}
  ...
  /* Safari does not extend the root background over the full height of every
     printed page, so any page whose content stops short shows bare paper at
     the bottom. A fixed-position layer is repeated on each sheet by the print
     engine, which fills every page edge to edge. Chrome already paints this
     correctly; the layer is harmless there. */
