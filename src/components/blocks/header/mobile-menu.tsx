      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-6">
          ...
          >
            ...
            <div className="space-y-2">
              {(Array.isArray(PAGES.services) ? PAGES.services : []).map(
                (service: any) => (
                  <Link
                    key={service.slug}
                    href={`/${service.slug}`}
          ...
          >
            ...
            <div className="space-y-2">
              {(Array.isArray(PAGES.industries) ? PAGES.industries : []).map(
                (industry: any) => (
                  <Link
                    key={industry.slug}
                    href={`/${industry.slug}`}
        ...
        <motion.div
          ...
          style={{ borderColor: "var(--border-default)" }}
        >
          <Button variant="accent" size="lg" fullSize onClick={onContactClick}>
            Let&apos;s talk
          </Button>
        </motion.div>
      </motion.div>
