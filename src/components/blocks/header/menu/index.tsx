      ...
      }
      {
        !isDesktop ? (
          ...
          <ul className="flex gap-8">
            <li
              className={`relative ${menuItemDesktopClass} ${isOpen && currentMenu === 'services' ? 'text-red' : ''}`}
            ...
            <li
              className={`relative ${menuItemDesktopClass} ${isOpen && currentMenu === 'industries' ? 'text-red' : ''}`}
            ...
            >
              <Link className="relative text-black" href="/case-studies">
                <div className="font-medium opacity-0">
                  Case Studies
                </div>
                <div className="absolute top-0 left-0">
            ...
            <li
              className={menuItemDesktopClass}
            >
              <Link className="relative text-black" href="/blog">
                <div className="font-medium opacity-0">
                  Blog
                </div>
                <div className="absolute top-0 left-0">
            ...
            <li
              className={menuItemDesktopClass}
            >
              <Link className="relative text-black" href="/about">
                <div className="font-medium opacity-0">
                  About us
                </div>
                <div className="absolute top-0 left-0">
            ...
            <li
              className={menuItemDesktopClass}
            >
              <Link className="relative text-black" href="/careers">
                <div className="font-medium opacity-0">
                  Careers
                </div>
                <div className="absolute top-0 left-0">
