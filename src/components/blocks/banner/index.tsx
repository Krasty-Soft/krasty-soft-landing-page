...
const mockAwards = [
    { emoji: '🏆', title: 'Top API Development Company', location: 'Ukraine 2026', platform: 'Clutch' },
    { emoji: '🥇', title: 'Top REST API Developers', location: 'Ukraine 2026', platform: 'Clutch' },
    { emoji: '⭐', title: 'Top Software Developers', location: 'Eastern Europe 2025', platform: 'GoodFirms' },
    { emoji: '💎', title: 'Best Custom Software Company', location: 'Ukraine 2025', platform: 'TechReviewer' },
]
            ...
            <StaggerWrapper className="relative z-10 max-w-6xl mx-auto flex flex-col items-center">
                ...
                <motion.div variants={staggerItem} className="mb-16 relative">
                    ...
                    <motion.div
                        ...
                        style={{
                            background: 'radial-gradient(circle, rgba(229, 6, 6, 0.6), rgba(229, 6, 6, 0.3) 50%, transparent 70%)',
                        }}
                        initial={false}
                        animate={{
                    ...
                    <motion.button
                        ...
                        style={{
                            background: 'linear-gradient(135deg, #E50606 0%, #FF2020 50%, #E50606 100%)',
                            color: 'var(--text-primary)',
                            border: 'none',
                            cursor: 'pointer',
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            style={{
                                background: 'linear-gradient(45deg, #FF0000, #E50606, #FF0000, #E50606)',
