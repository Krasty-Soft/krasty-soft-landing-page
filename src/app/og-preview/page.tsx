...
import LogoSVG from "@/assets/krastysoft-black.svg";
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 40%, #000 100%)",
          display: "flex",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(circle at top left, rgba(229, 6, 6, 0.3), transparent 60%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          style={{
            ...
            height: "500px",
            background:
              "radial-gradient(circle at bottom right, rgba(229, 6, 6, 0.25), transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          <div
            style={{
              ...
              height: "2px",
              background:
                "linear-gradient(90deg, transparent, #E50606, transparent)",
              marginTop: "8px",
            }}
          />
