...
import { Mail, Linkedin, MapPin, Users, Target } from "lucide-react";
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at center, var(--brand-red), transparent 70%)",
            pointerEvents: "none",
          }}
        />
    ...
    <>
      ...
      <Section variant="primary" animate={false}>
        <div style={{ paddingTop: "2rem", paddingBottom: "4rem" }}>
          ...
          >
            We are a young, ambitious{" "}
            <span style={{ color: "var(--brand-red)", fontWeight: 600 }}>
              Ukrainian company
            </span>{" "}
            driven by innovation and a profound commitment to excellence in
            software development. Beyond just code, we pride ourselves on
            cultivating a vibrant, supportive work environment where lightness,
            openness, and transparent communication are at the heart of
            everything we do.
          </motion.p>
      ...
      <Section variant="secondary" animate={false}>
        <div className="text-center mb-12">
          ...
          >
            ...
            dedicated to solving complex technical challenges. We don&apos;t
            just execute instructions; we act as strategic partners. Our
            commitment means we approach every client project{" "}
            <span style={{ color: "var(--brand-red)", fontWeight: 600 }}>
              as if it were our own
            </span>
            , ensuring unparalleled quality, proactive problem-solving, and
            solutions that are truly built for long-term success.
          </motion.p>
        </div>
      </Section>
      ...
      <Section variant="secondary" animate={false}>
        ...
        >
          Ready to discuss your next project with us? We&apos;re available for a
